...
BLOG_AUTHOR = "Alex Juda"  # (translatable)
...
BLOG_EMAIL = "alexanderjuda@gmail.com"
BLOG_DESCRIPTION = "Lessons I've learned while doing my side-projects."  # (translatable)
